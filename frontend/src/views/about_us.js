    ...
    return (
        <Stack padding={4} sx={{bgcolor: "#EEEEEE", borderRadius: 3}}>
            ...
            >
                <Grid item xs={6} xl={3}>
                    ...
                    >
                        ...
                        <Typography variant="h4" align="center" margin={4}>
                            We want to help <b>fitness content creators</b> to reach a large audience
                            of health-conscious consumers and fitness enthusiasts, while also
                            providing a <b>trustworthy</b> and <b>simple-to-use platform</b> where everybody
                            can easily find training plans, nutrition plans or fitness coachings suited
                            for their fitness level, preferences or dietary requirements.
                        </Typography>
                    </Paper>
                </Grid>
                ...
                <Grid item xs={6} xl={3}>
                    ...
                    >
                        ...
                        <Typography variant="h4" align="center" margin={4}>
                            FitHub is the platform where <b>fitness content creators</b> sell their
                            training and nutrition plans to <b>fitness enthusiasts</b> and <b>health-conscious consumers</b>.
                        </Typography>
                    </Paper>
                </Grid>
                ...
                <Grid item xs={6} xl={3}>
                    ...
                    >
                        ...
                        <Typography variant="h4" align="center" margin={4}>
                            ...
                            Technical University of Munich who are passionate about web application engineering. This application was created as
                            part of the course <i>SEBA Master: Web Application Engineering</i>.
                        </Typography>
                    </Paper>
                </Grid>
                <Grid item xs={6} xl={3}>
            ...
            <Typography variant="h4" align="center">
                ...
                developer account and refunded.
            </Typography>
        </Stack>
    );
}
