    ...
    >
      <Grid item xs={1}>
        <Stack
          ...
          maxWidth={1400}
        >
          <Typography variant="h1">Business Idea</Typography>
          ...
          <Typography variant="h4">
            This is not an actual Platform but rather just a fully functional
            proof of concept. All code is the shared intellectual property of
            the four aforementioned Team members. The Application is not
            licensed and any transactions done using the PayPal Payment System
            will be sent to a developer account and refunded. The Content and
