    ...
    return (
        <Stack padding={4} sx={{ bgcolor: "#EEEEEE", borderRadius: 3 }}>
            ...
            >
                ...
                >
                    <Typography align="center" fontSize="60px" fontWeight="700" color="white">
                        About us
                    </Typography>
            ...
            <Grid container direction="row" alignItems="stretch" spacing={8} padding={8}>
                ...
                <Grid item xs={12} md={6}>
                    <Paper
                        elevation={12}
                        height="100%"
                        sx={{ backgroundImage: `url(${AboutUs_Picture_1})`, borderRadius: 3, backgroundSize: "cover", p: 2, height: 1, minHeight: 400 }}
                    ></Paper>
                </Grid>
            </Grid>
            <Grid container direction="row" alignItems="stretch" spacing={8} padding={8}>
                <Grid item xs={12} md={6}>
                    <Paper
                        elevation={12}
                        height="100%"
                        sx={{ backgroundImage: `url(${AboutUs_Picture_2})`, borderRadius: 3, backgroundSize: "cover", p: 2, height: 1, minHeight: 400 }}
                    />
                </Grid>
                <Grid item xs={6} md={3}>
                    <Paper elevation={12} height="100%" sx={{ bgcolor: "#EEEEEE", backgroundSize: "cover", borderRadius: 3, p: 2, height: 1 }}>
            ...
            >
                <Typography variant="h1" align="center" fontSize="45px" color="#EEEEEE" paddingTop={8} paddingBottom={5}>
                    Meet our team
                </Typography>
                <Stack direction="row" spacing={6} justifyContent="space-around" padding={2}>
                    {members.map((item) => (
