  ...
  return (
    <Stack spacing={3}>
      ...
      <Typography>
        ...
        you, whether personally or on behalf of an entity and Fithub, concerning
        your access to and use of the Fithub as well as any other media form,
        media channel, mobile website or mobile application related, linked, or
        otherwise connected thereto. We are registered in Germany and have our
        registered office at Musterstraße 1, 12345 Musterstadt. The Site
        provides an online marketplace for the following goods, products, and/or
        services: Training plans, nutrition plans and coaching. In order to help
        make the Site a secure environment for the purchase and sale of
        Marketplace Offerings, all users are required to accept and comply with
        these Terms of Use. You agree that by accessing the Site and/or the
        Marketplace Offerings, you have read, understood, and agree to be bound
      ...
      <Typography>
        ...
        or modifications to these Terms of Use. We will alert you about any
      ...
      <Typography>
        ...
        these Terms of Use; (4) you are not under the age of 13; (5) you are not
        ...
        the Site or the Marketplace Offerings through automated or non-human
        means, whether through a bot, script or otherwise; (7) you will not use
        the Site for any illegal or unauthorized purpose; and (8) your use of
        the Site or the Marketplace Offerings will not violate any applicable
        law or regulation.
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        person, per household, or per order. These restrictions may in clude
      ...
      <Typography>
        The Site mayinvite you to chat, contribute to, or participate in blogs,
      ...
      <Typography>
        ...
        Offerings) links to other websites as well as articles, photographs,
      ...
      <Typography>
        ...
        contact information provided below. A copy of your Notification will be
      ...
      the protection provid ed to you by obligatory provisions of the law in
      your country to residence. Fithub and yourself both agree to submit to the
      non-exclusive jurisdiction of the courts of Munich, which means that you
      may ma ke a claim to defend your consumer protection rights in regards to
      these Conditions of Use in, or in the EU country in which you reside.
      ...
      <Typography>
        ...
        clause constitutes acceptance. The seat of arbitration shall be Munich,
      ...
      <Typography>
        ...
        BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE 6 MONTH
      ...
      <Typography>
        ...
        deemed severable from these Terms of Use and does not affect the v
        alidity and enforceability of any remaining provisions. There is no
        ...
        these Terms of Use. In order to resolve a complaint regarding the Site
        or the Marketplace Offerings or to receive further information regarding
