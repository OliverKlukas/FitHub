...
export function getMovies() {
    ...
    return async (dispatch) => {
        try {
            ...
            let movies = await ContentService.getMovies();
...
export function addMovie(movie) {
    ...
    return async (dispatch) => {
        try {
            await ContentService.createMovie(movie);
            dispatch(onSuccess());
        } catch (e) {
            onFailure(e);
        }
...
export function changeMovie(changedMovie) {
    ...
    return async (dispatch) => {
        try {
            let movie = await ContentService.updateMovie(changedMovie);
...
export const getMovie = (id) => {
    ...
    return async (dispatch, getState) => {
        try {
            let movie = await ContentService.getMovie(id);
            dispatch(onSuccess(movie));
        } catch (e) {
            onFailure(e);
        }
