    ...
    return (
        ...
        >
            ...
            <Stack justifyContent="space-between" spacing={2}>
                <HighlightButton variant="contained" sx={{ width: 300 }} component={RouterLink} target="_blank" to={"/sample.pdf"} download>
                    Download
                </HighlightButton>
                <StandardButton variant="contained" sx={{ width: 300 }} component={RouterLink} to={`/profile`}>
