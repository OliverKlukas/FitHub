...
export default function Footer() {
    return (<Stack spacing={2} direction="row" marginY={5} justifyContent="space-between">
        <Link color="#393E46" fontSize={14} fontWeight={300} underline="none" href="/terms-and-conditions"> Terms &
            Conditions</Link>
        ...
        <Link color="#393E46" fontSize={14} fontWeight={300} underline="none" href="/about"> About us</Link>
    </Stack>);
}